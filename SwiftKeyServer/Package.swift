...
let package = Package(
    name: "SwiftKeyServer",
    platforms: [.macOS(.v15)],
    products: [.executable(name: "swiftkey-server", targets: ["SwiftKeyServer"]), .executable(name: "swiftkey-operator", targets: ["SwiftKeyOperator"]), .library(name: "SwiftKeyAuthority", targets: ["SwiftKeyAuthority"])],
    dependencies: [
    ...
    targets: [
        ...
        .executableTarget(name: "SwiftKeyServer", dependencies: ["SwiftKeyAuthority", "SwiftKeyHTTP", .product(name: "SwiftKeyCore", package: "SwiftKeyCore"), .product(name: "Vapor", package: "vapor")], resources: [.process("Resources")]),
