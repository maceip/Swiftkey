...
val swiftLibrary = providers.gradleProperty("swiftui.library").orElse(
    rootDir.resolve(".build/arm64-apple-macosx/debug/libSwiftUIDesktopDemo.dylib").canonicalPath
).get()
